 ...
 * @author eddychou
 */
public class SettingSection extends JFrame implements ActionListener,WindowListener{
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource()==button1) {
            ...
            SettingExam settingExamFrame=new SettingExam(sectionName, timeLimit_h, timeLimit_m, timeLimit_s, numOfSub);
