...
//            }
        ...
        essayPanel.setLayout(new FlowLayout(FlowLayout.LEFT, 0, 0));
        JTextArea essayTextArea = new JTextArea();
        essayTextArea.setPreferredSize(new Dimension(800, 250));
        
        JTextArea wordLimit = new JTextArea("Word Limit: "+((Essay)question).getNoofwords());
        wordLimit.setEditable(false);
        //essayPanel.add(questionLabel);
        essayPanel.add(essayTextArea);
        essayPanel.add(wordLimit);
        questionDeleteButton.addActionListener(this);
